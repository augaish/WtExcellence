class ToolSubcheckpointTranslation < ApplicationRecord
  ...
  def update_last_modified_at
    return unless saved_change_to_name? || saved_change_to_description? || saved_change_to_multiple_choice_options?
  ...
  def content_changed?
    saved_change_to_name? || saved_change_to_description? || saved_change_to_multiple_choice_options?
  end
  ...
  def mark_other_translations_for_review
    ...
    tool_subcheckpoint.tool_subcheckpoint_translations
