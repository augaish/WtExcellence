class ChecklistItemTranslation < ApplicationRecord
  ...
  def content_changed?
    saved_change_to_text? || saved_change_to_guidance?
  end
  ...
  def mark_other_translations_for_review
    ...
    checklist_item.checklist_item_translations
