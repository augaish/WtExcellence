...
| Phase 12 (Review 03 section 5): work queue and setup checklist on the overview, supplier-linked risks and commitments | `ea4c9b7` | No migration. |
| Phase 13 (Review 03 section 7): SLA as its own capability — Agreements tab, typed other party, comparator/period/source/exclusions per level, measured periods with review and attainment | `PENDING_SHA` | Additive migration: columns on pp_records and pp_service_levels, `sla_measurements`, `sla_record_id` on commitments. |
