...
| Phase 6 (Review 03 correctness): Q01 limit text in document, Q02 DoA routes, Q03 owner name, Q04 AI error wording, Q05 proposed AI actions, Q07 package tabs, Q08 diagram fields, Q10 draft line and published date, Q17 wording | `PENDING_SHA` | No migration. New CapaAction status `proposed`. |
